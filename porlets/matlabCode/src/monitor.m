...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function writeEulerVorticity(o,eulerX,eulerY,vort)
% writeEulerVorticity(eulerX,eulerY,vort) writes the x and y
% coordinates of the Eulerian grid that is fixed and the vorticity at
% these points

[nx,ny] = size(eulerX);
% size of the output
fileName = [o.dataFile(1:end-8) 'EulerVorticity.bin'];
% take the name of the Data file, strip the word Data, and add on the
% word Vorticity
...
for k = 1:ny
  fwrite(fid,vort(1:nx,k),'double');
end
fclose(fid);

end % writeEulerVorticity
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [nx,ny,eulerX,eulerY,vort] = loadEulerVorticity(o,fileName)
...
for k = 1:ny
  iend = istart + nx - 1;
  vort(1:nx,k) = val(istart:iend);
  istart = iend + 1;
end

end % loadEulerVorticity
